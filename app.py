...
def main():
    ...
    spacer, col = st.columns([5, 1])    # Create columns for the Streamlit layout
    with col:
    ...
    groq_chat = ChatGroq(groq_api_key=groq_api_key,
                         model_name=model,
                         messages=[{'role': 'system','content': 'You are a rapper'},{'role': 'user','content': 'What can i do for you today?'}]
                        )
