...
def main():
    ...
    groq_chat = ChatGroq ( SystemMessagePromptTemplate=messages, groq_api_key=groq_api_key, model_name=model  )
    ...
    if user_question:
        ...
        message = {'system':messages,'human':user_question,'AI':response['response']}
