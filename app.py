...
def main():
    ...
    model = st.sidebar.selectbox(
        'Select a Model',
        ['mixtral-8x7b-32768', 'llama3-groq-70b-8192-tool-use-preview', 'llama-3.3-70b-versatile', 'deepseek-r1-distill-llama-70b', 'llama-3.1-8b-instant', 'llama3-70b-8192', 'llama3-8b-8192', 'gemma2-9b-it']
    )
